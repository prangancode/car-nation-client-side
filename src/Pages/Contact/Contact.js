...
const Contact = () => {
	...
	const handleSubmit = e => {
		...
		emailjs.sendForm('service_55xc1vd', 'template_ff8bxds', e.target, 'user_xvQe1qYZLCzayiUehNCfs')
			.then((res) => {
				// console.log(res);
				if (res.status === 200) {
					setIsSending(false);
						...
						<div className="contact-form-area flex flex-col md:flex-row-reverse md:justify-center">
							<div className="contact-details flex-initial md:pl-12 lg:pl-24 mb-12 md:mb-0">
								...
								<div className="mt-8">
									...
									<p className="text-sm">
										CAR NATION Showroom, <br />
										Banani Model Town, Dhaka, <br />
										Bangladesh.
									</p>
								</div>
								<div className="mt-8">
									...
									<p className="text-sm">
										<a href="mailto:demo@dummy.com">help@car-nation.com</a>
									</p>
								</div>
								<div className="mt-8">
									<h4 className="mb-2 tracking-normal">Phone</h4>
									<p className="text-sm">
										<a href="tel:+12029007178">+1 (202) 900 8156</a>
									</p>
								</div>
							</div>
