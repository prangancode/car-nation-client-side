...
import logo from '../../../../src/images/CAR NATION_ccexpress.png';
			...
			<header className="dashboard-header navbar static">
				<div className="px-4 w-full flex items-center justify-between">
					<div className="logo-wrapper flex-shrink-0 w-28 md:w-36">
						<Link to="/home">
							<img src={logo} alt="CAR NATION logo" className="w-full" />
						</Link>
					</div>
					<h2 className="flex-grow pl-8 truncate text-red-500 text-right md:text-center sm:text-lg tracking-normal md:text-xl lg:text-2xl">
						{user?.displayName}
					</h2>
				</div>
			</header>
