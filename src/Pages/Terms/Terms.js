			...
			<main id="terms_page" className="terms-page pt-16 md:pt-20">
				<section className="py-8 lg:py-12">
					<div className="container">
						...
						<p>
							By accessing this Website, accessible from https://car-nation.web.app/, you are agreeing to
						...
						<p>
							Permission is granted to temporarily download one copy of the materials on CAR NATION's
						...
						<ul>
							...
							<li>attempt to reverse engineer any software contained on CAR NATION's Website;</li>
						...
						<p>
							This will let CAR NATION to terminate upon violations of any of these restrictions. Upon
						...
						<p>
							All the materials on CAR NATION’s Website are provided "as is". CAR NATION makes no
							warranties, may it be expressed or implied, therefore negates all other warranties.
							Furthermore, CAR NATION does not make any representations concerning the accuracy or
						...
						<p>
							CAR NATION or its suppliers will not be hold accountable for any damages that will arise
							with the use or inability to use the materials on CAR NATION’s Website, even if CAR NATION
						...
						<p>
							The materials appearing on CAR NATION’s Website may include technical, typographical, or
							photographic errors. CAR NATION will not promise that any of the materials in this Website
							are accurate, complete, or current. CAR NATION may change the materials contained on its
							Website at any time without notice. CAR NATION does not make any commitment to update the
							materials.
						</p>
						...
						<p>
							CAR NATION has not reviewed all of the sites linked to its Website and is not responsible
							for the contents of any such linked site. The presence of any link does not imply
							endorsement by CAR NATION of the site. The use of any linked website is at the user’s own
							risk.
						</p>
						...
						<p>
							CAR NATION may revise these Terms of Use for its Website at any time without prior notice.
						...
						<p>
							Any claim related to CAR NATION's Website shall be governed by the laws of bd without
